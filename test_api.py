...
def test_chat():
    ...
    response = requests.post(f"{BASE_URL}/api/chat/rooms", json=room_data)
    ...
    if response.status_code == 200:
        ...
        response = requests.post(
            f"{BASE_URL}/api/chat/rooms/{room_id}/messages", json=message_data
        )
